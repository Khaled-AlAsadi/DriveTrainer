...
class TraficRuleQuestion(models.Model):
    question_text = models.CharField(max_length=500, validators=[
                                     MinLengthValidator(5),
                                     MaxLengthValidator(500)])
    pub_date = models.DateTimeField('date published')
    is_saved = models.BooleanField(default=False)
    link = models.CharField(max_length=500, validators=[
                            MinLengthValidator(5), MaxLengthValidator(500)])
...
class TraficRuleChoice(models.Model):
    ...
    choice_text = models.CharField(max_length=400, validators=[
                                   MinLengthValidator(5),
