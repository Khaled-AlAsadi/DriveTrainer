...
class TestModels(TestCase):
    ...
    def create_roadsign(self,title="The first Roadsign title",
        ...
        return RoadSign.objects.create(title=title, description=description,image_link=image_link)
    ...
    def create_traficrule(self,title="The first trafic rule title",
        ...
        return TraficRule.objects.create(title=title, sub_title=sub_title,sub_text=sub_text,image_link=image_link)
