...
from myapp.views import index, start_quiz, trafic_rules, continue_quiz
from myapp.views import road_signs_page, trafic_rule_question_detail
from myapp.views import next_question, previous_question
from myapp.views import create_roadSign_view, delete_roadSign_view
from myapp.views import update_roadSign_view, create_traficrule_view
from myapp.views import delete_traficrule_view, update_traficRule_view
